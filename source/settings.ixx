...
public:
    ...
    CSettings()
    {
        ...
        static CSetting arr[] = {
            ...
            { 0, "PREF_ALWAYSRUN",              "MISC",       "AlwaysRun",                          "",                           7, nullptr, (int32_t)AlwaysRunText.eMO_OFF, std::distance(std::begin(AlwaysRunText.data), std::end(AlwaysRunText.data)) - 1 }, //MENU_DISPLAY_SHADOW_DENSITY
...
public:
    ...
    struct
    {
        enum eAlwaysRunText { eOff, eOn, ePC, eConsole, eMO_OFF, eMO_ON, eArmedOnly, eNoJogging };

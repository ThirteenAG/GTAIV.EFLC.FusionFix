            ...
            if (bExtraDynamicShadows)
            {
                ...
                if (bExtraDynamicShadows >= 2)
                {
                    std::vector<std::string> miscNames = {
                        ...
                        "cityhalldet0",
                        "bens2_fragwall", "coop_projektwall3", "ec_sp_wall", "nj04e_bbwall01", "nj04e_brdgwall03",
                        ...
                        "dm_roofpipe02_mh7", "ks_pipe_works", "mh3_07_pipes0", "tg_fway_pipes",
                        ...
                        "bkn_bsh_stair2_e", "bkn_bsh_stair2_mid", "bkn_bsh_stair2_top", "pp_stairs01rail_mh12",
                        ...
                        "wh_load1_d_mh1", "wh_load2_d_mh1", "cj_scaffold_7", "mh3_07_barbers_det",
                        "ts_wigwamdet_01_dc9", "nj03_rubfnce_01", "ccbarrier1_mh7", "sw10_temp1newaly", "wi1_lightpoles", "et_radiomast", "nj_plumdingr",

            ...
            if (bExtraDynamicShadows)
            {
                ...
                if (bExtraDynamicShadows >= 2)
                {
                    std::vector<std::string> miscNames = {
                        ...
                        "fire_esc_9b", "fire_esc_10", "fire_esc_10b", "fire_esc_11", "fire_esc_11b", "fire_esc_11c", "fire_esc_12b", "ironsteps_mh12",
                        "fence",
                        ...
                        "seawall_det2_mh12", "seawall_det4_mh12", "seawall_det4c_mh12", "seawall_det5_mh12", "wii_bboard", "blankposter2_mh10",
                        ...
                        "dr_mh2_07_terrain_mh2", "gas_terr_mh2", "soho02_terrain_mh2", "04_terr01_mh2", "mh2_04_terb_mh2", "mh2_08_ter01_mh2",

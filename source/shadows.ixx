            ...
            if (bExtraDynamicShadows)
            {
                ...
                if (bExtraDynamicShadows >= 2)
                {
                    std::vector<std::string> miscNames = {
                        ...
                        "newroads_41b_mh3", "newroads_44_mh3", "road1_02_mh1", "road14_01_mh1", "road2_01_mh1", "road22_01_mh1", "road_02_mh2",
                        "road_03_mh2", "road_06b_mh2", "road_08_mh10", "road_10_mh2", "road_11_mh2", "road_12_mh4", "road_17_mh5", "road_20_mh04",
                        ...
                        "road_37_mh2", "road_37_mh5", "road_40_mh5", "road_49_mh5", "road_55_mh5", "road_56_mtf8", "road_59_mh7", "smordmanh03_mxr15",

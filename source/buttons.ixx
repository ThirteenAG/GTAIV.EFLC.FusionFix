...
private:
    ...
    static inline std::vector<std::string> buttons = {
        "UP_ARROW", "DOWN_ARROW", "LEFT_ARROW", "RIGHT_ARROW", "DPAD_UP", "DPAD_DOWN", "DPAD_LEFT", "DPAD_RIGHT",
        "DPAD_NONE", "DPAD_ALL", "DPAD_LEFTRIGHT", "DPAD_UPDOWN", "LSTICK_UP", "LSTICK_DOWN", "LSTICK_LEFT",
        "LSTICK_RIGHT", "LSTICK_NONE", "LSTICK_ALL", "LSTICK_LEFTRIGHT", "LSTICK_UPDOWN", "RSTICK_UP", "RSTICK_DOWN",
        "RSTICK_LEFT", "RSTICK_RIGHT", "RSTICK_NONE", "RSTICK_ALL", "RSTICK_LEFTRIGHT", "RSTICK_UPDOWN",
        "A_BUTT", "B_BUTT", "Y_BUTT", "X_BUTT", "LB_BUTT", "LT_BUTT", "RB_BUTT", "RT_BUTT", "START_BUTT",
        "BACK_BUTT", "A_BUTT", "B_BUTT"
    };
